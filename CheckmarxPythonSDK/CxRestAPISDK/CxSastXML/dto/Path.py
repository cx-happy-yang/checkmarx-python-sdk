...
class Path:
    ...
    def __str__(self):
        return (
            "Path(result_id={result_id}, path_id={path_id}, similarity_id={similarity_id}, "
            "source_method={source_method}, destination_method={destination_method}, "
            "path_nodes={path_nodes})".format(
                result_id=self.ResultId,
                path_id=self.PathId,
                similarity_id=self.SimilarityId,
                source_method=self.SourceMethod,
                destination_method=self.DestinationMethod,
