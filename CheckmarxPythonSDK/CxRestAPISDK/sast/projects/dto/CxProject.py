...
class CxProject(object):
    ...
    def __init__(
        ...
        name=None,
        is_public=None,
        source_settings_link=None,
        custom_fields=None,
        links=None,
        project_queue_settings=None,
        owner=None,
        is_deprecated=None,
        is_branched=None,
        original_project_id=None,
        branched_on_scan_id=None,
    ...
    def __str__(self):
        return """CxProject(project_id={}, team_id={}, name={}, 
            ...
            self.name,
            self.is_public,
            self.source_settings_link,
            self.custom_fields,
            self.links,
            self.project_queue_settings,
            self.owner,
            self.is_deprecated,
            self.is_branched,
            self.original_project_id,
            self.branched_on_scan_id,
