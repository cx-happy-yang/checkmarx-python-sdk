...
class Project:
    id: str = (
        None  # A unique identifier for the project. For 'upload' projects, a value must be entered.
    )
    ...
    tags: dict = None
    criticality: int = (
        3  # minimum: 1 maximum: 5 default: 3 example: 3 Criticality level of the project
    )
