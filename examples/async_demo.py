...
class ApiData:
    def __init__(self, request_data: RequestData, response_handler: Callable[[dict], dict] = None):
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        async with session.request(
            ...
            print(f"Location: {data['iss_position']['latitude']}, {data['iss_position']['longitude']}")
            # response to ProjectsCollection
